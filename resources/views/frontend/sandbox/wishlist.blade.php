                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="product-des product-name">
                                        <h5 class="product-name"><a href="{{ url('/product') }}">J.Crew Mercantile Women's Short-Sleeve</a></h5>
                                ...
                                <tr>
                                    <td class="image"><img src="frontend/imgs/shop/product-2-1.jpg" alt="#"></td>
                                    <td class="product-des">
                                        <h5 class="product-name"><a href="{{ url('/product') }}">Amazon Essentials Women's Tank</a></h5>
                                ...
                                <tr>
                                    <td class="image"><img src="frontend/imgs/shop/product-3-1.jpg" alt="#"></td>
                                    <td class="product-des">
                                        <h5 class="product-name"><a href="{{ url('/product') }}">Amazon Brand - Daily Ritual Women's Jersey </a></h5>
