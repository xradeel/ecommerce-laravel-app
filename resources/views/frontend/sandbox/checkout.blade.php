                    ...
                    <div class="order_review">
                        ...
                        <div class="table-responsive order_table text-center">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="image product-thumbnail"><img src="frontend/imgs/shop/product-1-1.jpg" alt="#"></td>
                                        <td>
                                            <h5><a href="{{ url('/product') }}">Yidarton Women Summer Blue</a></h5> <span class="product-qty">x 2</span>
                                        </td>
                                        <td>$180.00</td>
                                    </tr>
                                    <tr>
                                        <td class="image product-thumbnail"><img src="frontend/imgs/shop/product-2-1.jpg" alt="#"></td>
                                        <td>
                                            <h5><a href="{{ url('/product') }}">LDB MOON Women Summe</a></h5> <span class="product-qty">x 1</span>
                                        </td>
                                        <td>$65.00</td>
                                    </tr>
                                    <tr>
                                        <td class="image product-thumbnail"><img src="frontend/imgs/shop/product-3-1.jpg" alt="#"></td>
                                        <td><i class="ti-check-box font-small text-muted mr-10"></i>
                                            <h5><a href="{{ url('/product') }}">Women's Short Sleeve Loose</a></h5> <span class="product-qty">x 1</span>
                                        </td>
                                        <td>$35.00</td>
                                    </tr>
                                    <tr>
