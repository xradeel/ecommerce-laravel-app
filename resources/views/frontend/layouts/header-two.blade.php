...
<head>
    ...
    <link rel="stylesheet" href="frontend/css/maind134.css" />
</head>
                            ...
                            <div class="detail-gallery">
                                ...
                                <div class="product-image-slider">
                                    <figure class="border-radius-10">
                                        <img src="frontend/imgs/shop/product-16-2.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="frontend/imgs/shop/product-16-1.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="frontend/imgs/shop/product-16-3.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="frontend/imgs/shop/product-16-4.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="frontend/imgs/shop/product-16-5.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="frontend/imgs/shop/product-16-6.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="frontend/imgs/shop/product-16-7.jpg" alt="product image">
                                    </figure>
                                </div>
                                <div class="slider-nav-thumbnails pl-15 pr-15">
                                    <div><img src="frontend/imgs/shop/thumbnail-3.jpg" alt="product image"></div>
                                    <div><img src="frontend/imgs/shop/thumbnail-4.jpg" alt="product image"></div>
                                    <div><img src="frontend/imgs/shop/thumbnail-5.jpg" alt="product image"></div>
                                    <div><img src="frontend/imgs/shop/thumbnail-6.jpg" alt="product image"></div>
                                    <div><img src="frontend/imgs/shop/thumbnail-7.jpg" alt="product image"></div>
                                    <div><img src="frontend/imgs/shop/thumbnail-8.jpg" alt="product image"></div>
                                    <div><img src="frontend/imgs/shop/thumbnail-9.jpg" alt="product image"></div>
                                </div>
                            </div>
                            <div class="social-icons single-share">
                                <ul class="text-grey-5 d-inline-block">
                                    ...
                                    <li class="social-facebook"><a href="#"><img
                                                src="frontend/imgs/theme/icons/icon-facebook.svg" alt=""></a>
                                    </li>
                                    <li class="social-twitter"> <a href="#"><img
                                                src="frontend/imgs/theme/icons/icon-twitter.svg" alt=""></a>
                                    </li>
                                    <li class="social-instagram"><a href="#"><img
                                                src="frontend/imgs/theme/icons/icon-instagram.svg" alt=""></a>
                                    </li>
                                    <li class="social-linkedin"><a href="#"><img
                                                src="frontend/imgs/theme/icons/icon-pinterest.svg" alt=""></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info">
                            <ul>
                                ...
                                <li><i class="fi-rs-marker"></i><a href="{{ url('/contact-us') }}">Our location</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-4">
                        <div class="text-center">
                            <div id="news-flash" class="d-inline-block">
                                <ul>
                                    <li>Get great devices up to 50% off <a href="{{ url('/shop-left') }}">View
                                            details</a></li>
                                    <li>Supper Value Deals - Save more with coupons</li>
                                    <li>Trendy 25silver jewelry, save up 35% off today <a
                                            href="{{ url('/shop-left') }}">Shop now</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <ul class="language-dropdown">
                                        <li><a href="#"><img src="frontend/imgs/theme/flag-fr.png"
                                                    alt="">Français</a></li>
                                        <li><a href="#"><img src="frontend/imgs/theme/flag-dt.png"
                                                    alt="">Deutsch</a></li>
                                        <li><a href="#"><img src="frontend/imgs/theme/flag-ru.png"
                                                    alt="">Pусский</a></li>
                                    </ul>
                                </li>
                            </ul>
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                    <div class="logo logo-width-1">
                        <a href="{{ url('/') }}"><img src="frontend/imgs/theme/logo.svg" alt="logo"></a>
                    </div>
                    <div
                        ...
                        <nav>
                            <ul>
                                ...
                                <li><a class="{{ Request::is('shop-left') ? 'active' : '' }}"
                                ...
                                <li><a class="{{ Request::is('purchase-guide') ? 'active' : '' }}"
                                        href="{{ url('/purchase-guide') }}">Purchase Guide</a></li>
                                <li><a class="{{ Request::is('blogs') ? 'active' : '' }}"
                                        href="{{ url('/blogs') }}">Our Blogs</a></li>
                            </ul>
                        </nav>
                    </div>
                        ...
                        <ul class="mobile-menu">
                            ...
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a
                                ...
                                <ul class="dropdown">
                                    ...
                                    <li>
                                        <a href="{{ url('/purchase-guide') }}">Purchase Guide</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a
