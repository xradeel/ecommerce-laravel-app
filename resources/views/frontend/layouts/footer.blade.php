            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="widget-about font-md mb-md-5 mb-lg-0">
                        ...
                        <p class="wow fadeIn animated">
                            <strong>Address: </strong>57000 Furniture Road, Street 32, Sahiwal
                        </p>
                        <p class="wow fadeIn animated">
                            <strong>Phone: </strong>+01 2222 365 /(+92) 314 7128128
                        </p>
                        <p class="wow fadeIn animated">
                ...
                <div class="col-lg-2 col-md-3">
                    ...
                    <ul class="footer-list wow fadeIn animated mb-sm-5 mb-md-0">
                        ...
                        <li><a href="{{url('/not-found')}}">Delivery Information</a></li>
                ...
                <div class="col-lg-2 col-md-3">
                    <h5 class="widget-title wow fadeIn animated">Categories</h5>
                    <ul class="footer-list wow fadeIn animated">
                        <li><a href="{{url('/shop-left')}}">Women's Clothing</a></li>
                        <li><a href="{{url('/shop-left')}}">Men's Clothing</a></li>
                        <li><a href="{{url('/shop-left')}}">Jewelry & Accessories</a></li>
                        <li><a href="{{url('/shop-left')}}">Shoes</a></li>
                        <li><a href="{{url('/shop-left')}}">Bags</a></li>
                        <li><a href="{{url('/shop-left')}}">Beauty, Health</a></li>
                    </ul>
                </div>
                <div class="col-lg-4">
