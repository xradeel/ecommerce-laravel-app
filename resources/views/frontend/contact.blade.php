            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <p class="wow fadeIn animated">
                        ...
                        <a class="btn btn-outline btn-lg btn-brand-outline font-weight-bold text-brand bg-white text-hover-white ml-15 border-radius-5 btn-shadow-brand hover-up" href="{{ url('/not-found') }}">Support Center</a>
                    </p>
                </div>
            </div>
        </div>
