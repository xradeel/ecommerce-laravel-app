                            ...
                            <div class="col-lg-10 m-auto entry-main-content">
                                ...
                                <div class="social-icons single-share">
                                    <ul class="text-grey-5 d-inline-block">
                                        ...
                                        <li class="social-facebook"><a href="#"><img src="frontend/imgs/theme/icons/icon-facebook.svg" alt=""></a></li>
                                        <li class="social-twitter"> <a href="#"><img src="frontend/imgs/theme/icons/icon-twitter.svg" alt=""></a></li>
                                        <li class="social-instagram"><a href="#"><img src="frontend/imgs/theme/icons/icon-instagram.svg" alt=""></a></li>
                                        <li class="social-linkedin"><a href="#"><img src="frontend/imgs/theme/icons/icon-pinterest.svg" alt=""></a></li>
                                    </ul>
                                </div>
...
"><i class="fi-rs-search"></i></a>
                                                    <a aria-label="Add To Wishlist" class="action-btn small hover-up" href="{{ url('/wishlist') }}" tabindex="0"><i class="fi-rs-heart"></i></a>
                                            ...
                                            <div class="product-content-wrap">
                                                <h2><a href="{{ url('/product') }}" tabindex="0">Ulstra Bass Headphone</a></h2>
...
"><i class="fi-rs-search"></i></a>
                                            ...
                                            <div class="product-content-wrap">
                                                <h2><a href="{{ url('/product') }}" tabindex="0">Smart Bluetooth Speaker</a></h2>
                                                <div class="rating-result" title="90%">
                                                    <span>
                                                    </span>
                                                </div>
...
"><i class="fi-rs-search"></i></a>
                                            ...
                                            <div class="product-content-wrap">
                                                <h2><a href="{{ url('/product') }}" tabindex="0">HomeSpeak 12UEA Goole</a></h2>
                                                <div class="rating-result" title="90%">
                                                    <span>
                                                    </span>
                                                </div>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap small hover-up mb-0">
                                            ...
                                            <div class="product-content-wrap">
                                                <h2><a href="{{ url('/product') }}" tabindex="0">Dadua Camera 4K 2022EF</a></h2>
                                                <div class="rating-result" title="90%">
                                                    <span>
                                                    </span>
                                                </div>
