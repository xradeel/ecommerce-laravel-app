                                ...
                                <div class="col-md-6 m-auto col-sm-12 col-xs-12">
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            @foreach ($product->images as $image)
                                                <figure class="border-radius-10">
                                                    <img src="{{ asset('frontend/imgs/shop/' . $image->image_path) }}"
                                                        alt="product image">
                                                </figure>
                                            @endforeach
                                            <!-- <figure class="border-radius-10">
                                        ...
                                        <div class="slider-nav-thumbnails pl-15 pr-15">
                                            ...
                                            @foreach ($product->images as $image)
                                                <div><img src="{{ asset('frontend/imgs/shop/' . $image->image_path) }}"
                                ...
                                <div class="detail-info">
                                    ...
                                    <div class="clearfix product-price-cover">
                                        <div class="product-price primary-color float-left">
                                            ...
                                            <span class="save-price  font-md color3 ml-15">{{intval($discount).'% Off'}}</span>
                                        </div>
                                    </div>
