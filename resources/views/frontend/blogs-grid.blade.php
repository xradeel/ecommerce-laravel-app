                        ...
                        <div class="row">
                                ...
                                <article class="first-post mb-30 wow fadeIn animated hover-up">
                                    ...
                                    <div class="entry-content">
                                        <div class="entry-meta meta-1 mb-30">
                                            <a class="entry-meta meta-0" href="blog-category-grid.html"><span class="post-in background4 text-brand font-xs">Mobile Phone</span></a>
                                            <div class="font-sm">
                                        ...
                                        <h2 class="post-title mb-20">
                                            <a href="{{ url('/blog-post') }}">Barcelona: marathan; south korean pulls away for a grueling surprise</a>
                                        </h2>
                                        ...
                                        <div class="mb-20 entry-meta meta-2">
                                            <div class="font-xs ">
                                                <span class="post-by">By <a href="blog-category-grid.html">Azimeto</a></span>
                                            ...
                                            <a href="{{ url('/blog-post') }}" class="btn btn-sm">Read more<i class="fi-rs-arrow-right ml-10"></i></a>
                                        </div>
                                    </div>
                                </article>
                            </div>
                                ...
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="{{ url('/blog-post') }}">The litigants on the screen are not actors</a>
                                        </h3>
                                        ...
                                        <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
                                            ...
                                            <a href="{{ url('/blog-post') }}" class="text-brand">Read more <i class="fi-rs-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </article>
                            </div>
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="{{ url('/blog-post') }}">Essential Qualities of Highly Successful Music</a>
                                        </h3>
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="{{ url('/blog-post') }}">9 Things I Love About Shaving My Head</a>
                                        </h3>
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="{{ url('/blog-post') }}">Why Teamwork Really Makes The Dream Work</a>
                                        </h3>
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="{{ url('/blog-post') }}">The World Caters to Average People</a>
                                        </h3>
