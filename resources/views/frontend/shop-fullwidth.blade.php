                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="product-cart-wrap mb-30">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="{{ url('/shop-left') }}">Colorful Pattern Shirts</a></h2>
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="product-cart-wrap mb-30">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="{{ url('/shop-left') }}">Cartoon Astronaut T-Shirts</a></h2>
                                    <div class="rating-result" title="90%">
                                        <span>
                                            <span>50%</span>
                                        </span>
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="product-cart-wrap mb-30">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="{{ url('/shop-left') }}">Plain Striola Shirts</a></h2>
                                    <div class="rating-result" title="90%">
                                        <span>
                                            <span>95%</span>
                                        </span>
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="product-cart-wrap mb-30">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="{{ url('/shop-left') }}">Landscape Painting Shirt</a></h2>
                                    <div class="rating-result" title="90%">
                                        <span>
                                            <span>70%</span>
                                        </span>
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="product-cart-wrap mb-30">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="{{ url('/shop-left') }}">Letter Print T-Shirt</a></h2>
                                    <div class="rating-result" title="90%">
                                        <span>
                                            <span>70%</span>
                                        </span>
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="product-cart-wrap mb-30">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="{{ url('/shop-left') }}">Element Pattern Print Shirts</a></h2>
                                    <div class="rating-result" title="90%">
                                        <span>
                                            <span>70%</span>
                                        </span>
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="product-cart-wrap mb-30">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="{{ url('/shop-left') }}">Vintage Henley Shirt</a></h2>
                                    <div class="rating-result" title="90%">
                                        <span>
                                            <span>98%</span>
                                        </span>
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="product-cart-wrap mb-30">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="{{ url('/shop-left') }}">Cotton Leaf Printed</a></h2>
                                    <div class="rating-result" title="90%">
                                        <span>
                                            <span>70%</span>
                                        </span>
